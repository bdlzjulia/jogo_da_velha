...
var jogadorSelecionado = document.getElementById('jog-sel');

var vencedorSelecionado = document.getElementById('ven-sel');
...
function corQuadrado(quadrado1, quadrado2, quadrado3){
    quadrado1.style.background = '#459061'
    quadrado2.style.background = '#459061'
    quadrado3.style.background = '#459061'
}
...
function reiniciar() {
    ...
    for (var i=1; i <= 9; i++){
        ...
        quadrado.style.background = '#4582C7';
        quadrado.style.color = '#4582C7';
        quadrado.innerHTML = '-';
    }
